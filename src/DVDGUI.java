...
public class DVDGUI implements DVDUserInterface {
	 ...
	 public void processCommands()
	 {
		 ...
		 do {
			 ImageIcon icon = new ImageIcon("/Users/Ryan/Desktop/movie.png"); //change file trace for different picture
	...
	private void doAddOrModifyDVD() {
		...
		if (time == null) {
                ...
                JOptionPane.showMessageDialog(null, title + " added to collection.");
	}
	...
	private void doRemoveDVD() {
		...
		title = title.toUpperCase();
                ...
                // Display current collection to the console for debugging
                JOptionPane.showMessageDialog(null, title + " removed from collection.");
	}
    ...
    private void doGetTotalRunningTime() {
                ...
                JOptionPane.showMessageDialog(null, "Total Running Time of DVDs: " + total + " min.");
        }
